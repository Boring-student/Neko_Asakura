var LANGUAGES = {
    ...
    "en": {
        ...
        texts: {
            "page-title": "Welcome to Neko Asakura~",
            "doc-title": "Flappy~",
            "page-descriptions": "The website for Neko, the gamer girl Cytus 2 character out there.",
            "counter-descriptions": ["The Neko~ has been flapped for", "Asakura has been Flapp~ed for"],
            "counter-unit": "times",
            "counter-button": ["Flap the Neko~!", "Neko Neko~!"],
            "access-via-pages": "You're currently accessing via GitHub Pages. ",
